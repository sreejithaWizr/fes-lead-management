...
import LeadInformationForm from './subForms/LeadInfoForm';
import EducationQualificationForm from './subForms/LeadEducationForm';
import LeadStatusForm from './subForms/LeadStatusForm';
import LeadSourceForm from './subForms/LeadSourceForm';
...
const ErrorObserver = ({ setTabErrors }) => {
    ...
    useEffect(() => {
        ...
        const leadInfoFields = ['firstName', 'lastName', 'email', 'secondaryEmail', 'mobileNumber', 'alternativeNumber', 'whatsappNumber', 'leadOwner', 'leadStatusInfo', 'priority', 'teleCallerName', 'leadCreated'];
        const educationFields = ['highestQualification', 'graduationYear', 'fieldOfStudy', 'cgpaGrade', 'workExperience', 'preferredDestination', 'otherCountries', 'testName', 'testTrainindBoolean'];
        ...
        // const hasLeadInfoErrors = Object.keys(errors).some(field => leadInfoFields.includes(field));
        // const hasEducationErrors = Object.keys(errors).some(field => educationFields.includes(field));
        // const hasStatusErrors = Object.keys(errors).some(field => statusFields.includes(field));
        // const hasSourceErrors = Object.keys(errors).some(field => sourceFields.includes(field));
...
const CreateLeadComponent = () => {
    ...
    const handleSubmit = (values, { setSubmitting }) => {
        ...
        console.log('Education Qualification:', {
            ...
            testTrainindBoolean: values?.testTrainindBoolean,
        });
