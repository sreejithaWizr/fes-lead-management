...
const EditOrganisationPage = () => {
    ...
    const orgDetails = {
        initials: `${orgData?.first_name?.charAt(0) || ''}${orgData?.last_name?.charAt(0) || ''}`,
        name: `${orgData?.first_name} ${orgData?.last_name}`,
        status: 'May be Prospective',
        id: `${orgData?.lead_number}`,
        email: `${orgData?.email}`,
        phone: `${orgData?.mobile_number}`,
    };
    ...
    return (
        <div className="w-full h-full">
            <LeadDetailsHeader organisation={orgDetails} />
